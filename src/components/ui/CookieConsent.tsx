...
export default function CookieConsent() {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 z-[45] p-4 md:p-6 mb-[80px] md:mb-[100px] glass-premium border-t border-slate-200 shadow-2xl bg-white/90 backdrop-blur-md">
