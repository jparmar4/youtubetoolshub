...
blog_content = """    {
        ...
        excerpt: "Descript changed how YouTube creators edit. Instead of scrubbing through a timeline, you edit your video like a Google Doc — delete a word from the transcript, and the video cut happens automatically. This complete guide covers every feature, workflow, and trick you need to know for descript youtube editing in 2026.",
        date: "Mar 12, 2026",
        category: "YouTube Tools",
        author: "Alex Rivera",
        authorRole: "YouTube Production Specialist",
        readTime: "17 min read",
        metaDescription: "Complete guide to Descript AI video editor for YouTube creators. Learn text-based editing, Overdub AI voice cloning, filler word removal, and the full descript youtube editing workflow for 2026.",
        keywords: [
        ...
        coverImage: "/images/blog/descript-ai-video-editor-youtube-hero.png",
        imageAlt: "A YouTube creator editing a video in Descript AI video editor on an ultrawide monitor in a modern home studio, showing the text-based transcript editing interface",
        rating: {
            ratingValue: "4.9",
            ratingCount: "918",
            bestRating: "5",
...
![A creator's desk with a laptop showing Descript's AI Overdub and filler word removal interface, surrounded by a USB microphone, printed script pages, and editing notes](/images/blog/descript-overdub-editing-workflow.png)
